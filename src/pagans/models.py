...
This module contains model family detection and model-name mappings used to
route optimization through OpenRouter while targeting provider-specific models.
"""
