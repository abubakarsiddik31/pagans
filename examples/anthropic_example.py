"""
Simple example of using PAGANS with Anthropic Claude models.
...
async def main():
    """Main example function for Anthropic Claude optimization using PAGANS."""
    ...
    # Test with Claude 3.5 Sonnet using short model name
    target_model = "claude-3.5-sonnet"

    try:
        print("🚀 Optimizing prompt for Claude 3.5 Sonnet using PAGANS...")
